  ...
  if (isLoadingAfterGenie) {
    return (
      ...
      >
        ...
        <h3 className="mt-8 text-xl font-bold text-white animate-pulse">
          Generating Compliance Report...
        </h3>
        <p className="mt-3 text-xs text-slate-400 text-center max-w-sm font-sans leading-relaxed">
          Our AI engine is scanning your transcript, identifying governance risks, mapping compliance standards, and compiling the audit report.
        </p>
      </motion.div>
    )
  }
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <div
                    ...
                    className="rounded-[24px] border border-dashed border-white/10 bg-slate-950/20 p-8 text-center hover:border-slate-800 transition-colors cursor-pointer"
                  >
                    <div className="mx-auto h-12 w-12 rounded-xl bg-slate-900 border border-slate-800 text-slate-350 flex items-center justify-center shadow-sm mb-3">
                      <Upload className="h-5 w-5" />
                    </div>
                    <p className="text-xs font-bold text-slate-300">Drag & drop raw transcript files here</p>
                ...
                {formData.transcript && (
                  <div className="flex items-center justify-between rounded-xl border border-emerald-500/20 bg-emerald-500/10 p-4 transition-all">
                    ...
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      className="text-xs font-semibold border-emerald-500/30 text-emerald-450 bg-slate-900/60 hover:bg-slate-800"
                ...
                {(!formData.transcript || showPreview) && (
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      rows={8}
                      className="rounded-[24px] border border-white/5 bg-slate-950/60 p-4 font-sans text-xs text-slate-100 outline-none focus:border-indigo-500/30"
                    />
                  </div>
                )}
                ...
                <div className="flex justify-between items-center border-t border-white/5 pt-6">
                  ...
                  <Button 
                    type="button" 
                    className="rounded-xl bg-indigo-650 hover:bg-indigo-700 text-white text-xs px-5 py-4 border-0 font-semibold shadow-sm gap-1"
              ...
              >
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={handleInputChange}
                      required
                      className="rounded-xl border border-white/5 bg-slate-950/60 p-3 text-xs text-slate-100 focus:border-indigo-500/30 focus:ring-0"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={formData.region} onValueChange={(val) => handleSelectChange('region', val)}>
                      <SelectTrigger className="rounded-xl border border-white/5 bg-slate-950/60 text-xs text-slate-200 focus:ring-0">
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={handleInputChange}
                      required
                      className="rounded-xl border border-white/5 bg-slate-950/60 p-3 text-xs text-slate-100 focus:border-indigo-500/30 focus:ring-0 [color-scheme:dark]"
                    />
                  </div>
                ...
                <div className="flex justify-between items-center border-t border-white/5 pt-6">
                  <Button 
                    type="button" 
                    variant="outline" 
                    className="rounded-xl border-white/5 bg-slate-900/50 hover:bg-slate-800 text-slate-300 hover:text-white gap-1.5"
                  ...
                  <Button 
                    type="submit" 
                    className="rounded-xl bg-indigo-650 hover:bg-indigo-700 text-white text-xs px-6 py-4 border-0 font-semibold shadow-md gap-1.5"
                  >
                    Generate Report
                  </Button>
                </div>
